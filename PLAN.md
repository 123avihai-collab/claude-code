...
**עלות**: **0 ש"ח לתמיד** - הכל ב-Tier חינמי של Firebase Spark. אין חיוב כרטיס אשראי, גם אם יחרגו מהמגבלות - השירות פשוט מפסיק, לא מחייב.
...
- [ ] **חשוב**: לוודא שה-Project ב-**Spark Plan** (החינמי) - לא לחבר כרטיס אשראי
