...
export const partialBills: PartialBill[] = [
  ...
  },
  {
    ...
    boqItems: [
      {
        itemCode: "02.38.06.001",
        description: "רכש ואספקת צינורות פלדה 8\" ASTM A106 Grade B",
        unit: "קומפ'",
        contractQuantity: 1,
        unitPrice: 1_800_000,
        previousCumulativeQty: 0,
        currentBillQty: 1,
        cumulativeQtyAfter: 1,
        currentBillAmount: 1_800_000,
        cumulativeAmount: 1_800_000,
      },
      {
        itemCode: "02.38.06.005",
        description: "רכש ואספקת מגופים ואביזרי קצה",
        unit: "קומפ'",
        contractQuantity: 1,
        unitPrice: 850_000,
        previousCumulativeQty: 0,
        currentBillQty: 0.7,
        cumulativeQtyAfter: 0.7,
        currentBillAmount: 595_000,
        cumulativeAmount: 595_000,
      },
      {
        itemCode: "02.01.05.012",
        description: "עבודות עפר וחפירה לקו צנרת",
        unit: "מ\"ק",
        contractQuantity: 1200,
        unitPrice: 350,
        previousCumulativeQty: 280,
        currentBillQty: 720,
        cumulativeQtyAfter: 1000,
        currentBillAmount: 252_000,
        cumulativeAmount: 350_000,
      },
      {
        itemCode: "02.38.01.040",
        description: "הנחת צינור פלדה 8\" כולל הכנת תווי לפי תכנית",
        unit: "מ\"א",
        contractQuantity: 1100,
        unitPrice: 1_850,
        previousCumulativeQty: 80,
        currentBillQty: 320,
        cumulativeQtyAfter: 400,
        currentBillAmount: 592_000,
        cumulativeAmount: 740_000,
      },
      {
        itemCode: "02.38.01.085",
        description: "ריתוכים לפי תקן API 1104 כולל בדיקת MPI",
        unit: "יח'",
        contractQuantity: 95,
        unitPrice: 4_500,
        previousCumulativeQty: 5,
        currentBillQty: 25,
        cumulativeQtyAfter: 30,
        currentBillAmount: 112_500,
        cumulativeAmount: 135_000,
      },
      {
        itemCode: "02.38.05.020",
        description: "התקנת אנודות הגנה קתודית מגנזיום + כבילה",
        unit: "יח'",
        contractQuantity: 40,
        unitPrice: 2_800,
        previousCumulativeQty: 0,
        currentBillQty: 12,
        cumulativeQtyAfter: 12,
        currentBillAmount: 33_600,
        cumulativeAmount: 33_600,
      },
      {
        itemCode: "02.01.06.020",
        description: "יציקת בטון מסביב לעמודי תמיכה",
        unit: "מ\"ק",
        contractQuantity: 80,
        unitPrice: 1_200,
        previousCumulativeQty: 0,
        currentBillQty: 50,
        cumulativeQtyAfter: 50,
        currentBillAmount: 60_000,
        cumulativeAmount: 60_000,
      },
      {
        itemCode: "02.38.07.001",
        description: "עבודות רג'י - שעות עבודה לפי הוראת מפקח",
        unit: "ש\"ע",
        contractQuantity: 800,
        unitPrice: 280,
        previousCumulativeQty: 110,
        currentBillQty: 290,
        cumulativeQtyAfter: 400,
        currentBillAmount: 81_200,
        cumulativeAmount: 112_000,
      },
      {
        itemCode: "—",
        description: "תוספות וחריגים (ראה פירוט בלשונית חריגים)",
        unit: "קומפ'",
        contractQuantity: 1,
        unitPrice: 63_500,
        previousCumulativeQty: 0,
        currentBillQty: 1,
        cumulativeQtyAfter: 1,
        currentBillAmount: 63_500,
        cumulativeAmount: 63_500,
      },
      {
        itemCode: "—",
        description: "הערה: שינוי מועד המסירה מאושר",
        unit: "הערה",
        contractQuantity: 0,
        unitPrice: 0,
        previousCumulativeQty: 0,
        currentBillQty: 0,
        cumulativeQtyAfter: 0,
        currentBillAmount: 0,
        cumulativeAmount: 0,
      },
    ],
    ...
    boqItems: [
      {
        ...
        previousCumulativeQty: 80,
        currentBillQty: 15,
        cumulativeQtyAfter: 95,
        currentBillAmount: 67_500,
        cumulativeAmount: 427_500,
      },
      {
        itemCode: "02.38.05.020",
        description: "התקנת אנודות הגנה קתודית מגנזיום + כבילה",
        ...
        contractQuantity: 40,
        unitPrice: 2_800,
        previousCumulativeQty: 30,
        currentBillQty: 10,
        cumulativeQtyAfter: 40,
        currentBillAmount: 28_000,
        cumulativeAmount: 112_000,
      },
      {
        itemCode: "02.38.05.030",
        description: "מערכת בקרה לקתודית - תאי מדידה והגדרות סופיות",
        unit: "קומפ'",
        contractQuantity: 1,
        unitPrice: 145_000,
        previousCumulativeQty: 0,
        currentBillQty: 1,
        cumulativeQtyAfter: 1,
        currentBillAmount: 145_000,
        cumulativeAmount: 145_000,
      },
      {
        itemCode: "02.38.04.010",
        description: "צביעה ומיגון נגד קורוזיה - שכבת גמר",
        unit: "מ\"ק",
        contractQuantity: 320,
        unitPrice: 480,
        previousCumulativeQty: 200,
        currentBillQty: 120,
        cumulativeQtyAfter: 320,
        currentBillAmount: 57_600,
        cumulativeAmount: 153_600,
      },
      {
        itemCode: "02.38.02.015",
        description: "ניקיון קווי דלק + התקנת כיסויים סופיים",
        unit: "מ\"א",
        contractQuantity: 1100,
        unitPrice: 95,
        previousCumulativeQty: 800,
        currentBillQty: 300,
        cumulativeQtyAfter: 1100,
        currentBillAmount: 28_500,
        cumulativeAmount: 104_500,
      },
      {
        itemCode: "02.38.07.001",
        description: "עבודות רג'י - שעות עבודה לפי הוראת מפקח",
        ...
        contractQuantity: 800,
        unitPrice: 280,
        previousCumulativeQty: 670,
        currentBillQty: 130,
        cumulativeQtyAfter: 800,
        currentBillAmount: 36_400,
        cumulativeAmount: 224_000,
      },
      {
        itemCode: "—",
        description: "תוספות וחריגים (ראה פירוט בלשונית חריגים)",
